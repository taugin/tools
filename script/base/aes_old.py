...
def encrypt_file(key, input_file, output_file):
    ...
    cmdlist.append("-jar")
    cmdlist.append(Common.AES_JAR_OLD)
    cmdlist.append("-e")
    if BINARY:
        cmdlist.append("-b")
    cmdlist.append("-k")
...
def encrypt_string(key, input_string):
    ...
    cmdlist = [Common.JAVA(), "-jar", Common.AES_JAR_OLD, "-e", "-k", key, "-s", input_string]
    subprocess.call(cmdlist)
    Log.out("")
...
def decrypt_string(key, input_string):
    ...
    cmdlist = [Common.JAVA(), "-jar", Common.AES_JAR_OLD, "-d", "-k", key, "-s", input_string]
    subprocess.call(cmdlist)
    Log.out("")
# start ============================================================================================
def usage():
