...
for /F "tokens=1 delims=}" %%i in ("%ACTIVITY_NAME%") do (set ACTIVITY_NAME=%%i)
rem echo ACTIVITY_NAME=%ACTIVITY_NAME%
...
echo [Logging...] USER_ID : [%USER_ID%]
echo [Logging...] PACKAGE_NAME : [%PACKAGE_NAME%]
echo [Logging...] ACTIVITY_NAME : [%ACTIVITY_NAME%]
